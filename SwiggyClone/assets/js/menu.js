document.addEventListener("DOMContentLoaded", function () {
  ...
  const menuHeadingsContainer = document.getElementById(
  ...
  fetch("https://mocki.io/v1/15c4f84b-539f-4281-9a26-8ca758a7c0c3")
    ...
    .then((data) => {
      ...
      sourceElement.setAttribute(
        "src",
        "assets/img/restaurants/Cook with me.mp4"
      );
    ...
    .then((data) => {
      ...
      function displayCategory(category, categoryName) {
        ...
        category.forEach((product) => {
          ...
          menuBoxDescription.textContent =
      ...
      searchButton.addEventListener("click", function () {
        ...
        if (keyword === "") {
          ...
          allMenuItems.forEach((menuItem) => {
            ...
            const description =
              menuItem.querySelector(".description").textContent;
...
function addToCart(itemDetails) {
  ...
  fetch(
    "https://script.google.com/macros/s/AKfycbztl0rb7AMLtddgLj9BKzmFD-UrBjpu4QiwbuTA4h8ybjqiD1bE1X8GmHXYGovBvqGh/exec",
    {
      method: "POST",
...
window.addEventListener("load", function () {
  fetch(
    "https://script.google.com/macros/s/AKfycbztl0rb7AMLtddgLj9BKzmFD-UrBjpu4QiwbuTA4h8ybjqiD1bE1X8GmHXYGovBvqGh/exec?clear=true",
    {
      method: "POST",
    }
  )
