...
//   // const searchIcon = document.querySelector(".searchBarIcon").addEventListener('click',searchFoods());


//   const string = "laptops"; 


//     const foodItem = document.querySelector(".searchInput")
